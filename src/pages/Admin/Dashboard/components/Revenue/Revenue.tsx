	...
	return (
		<div className={classes.root}>
			<SimpleGrid cols={3} breakpoints={[{ maxWidth: 'sm', cols: 1 }]}>
				<Statistics isLoading={ordersLoading} title={'Revenue'} value={revenue} diff={40} />
				<Statistics isLoading={ordersLoading} title={'Orders'} value={totalPaidOrders} diff={24} />
				<Statistics isLoading={isLoading} title={'Submissions'} value={submissions} diff={10} />
			</SimpleGrid>
		</div>
	);
}
